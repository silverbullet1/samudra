 ...
 */
#define portTickType long
portBASE_TYPE xSerialGetChar( xComPortHandle pxPort, unsigned portBASE_TYPE *pcRxedChar, unsigned portTickType xBlockTime );
portBASE_TYPE xSerialPutChar( xComPortHandle pxPort, unsigned portBASE_TYPE cOutChar, unsigned portTickType xBlockTime );
